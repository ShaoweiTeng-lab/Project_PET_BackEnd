...
import project_pet_backEnd.ecpay.payment.integration.domain.ATMRequestObj;
import project_pet_backEnd.ecpay.payment.integration.domain.AioCheckOutALL;
import project_pet_backEnd.ecpay.payment.integration.domain.AioCheckOutApplePay;
import project_pet_backEnd.ecpay.payment.integration.domain.AioCheckOutATM;
import project_pet_backEnd.ecpay.payment.integration.domain.AioCheckOutBARCODE;
import project_pet_backEnd.ecpay.payment.integration.domain.AioCheckOutCVS;
import project_pet_backEnd.ecpay.payment.integration.domain.AioCheckOutDevide;
import project_pet_backEnd.ecpay.payment.integration.domain.AioCheckOutOneTime;
import project_pet_backEnd.ecpay.payment.integration.domain.AioCheckOutPeriod;
import project_pet_backEnd.ecpay.payment.integration.domain.AioCheckOutWebATM;
import project_pet_backEnd.ecpay.payment.integration.domain.CVSOrBARCODERequestObj;
import project_pet_backEnd.ecpay.payment.integration.domain.CreateServerOrderObj;
import project_pet_backEnd.ecpay.payment.integration.domain.DoActionObj;
import project_pet_backEnd.ecpay.payment.integration.domain.FundingReconDetailObj;
import project_pet_backEnd.ecpay.payment.integration.domain.InvoiceObj;
import project_pet_backEnd.ecpay.payment.integration.domain.QueryCreditCardPeriodInfoObj;
import project_pet_backEnd.ecpay.payment.integration.domain.QueryTradeInfoObj;
import project_pet_backEnd.ecpay.payment.integration.domain.QueryTradeObj;
import project_pet_backEnd.ecpay.payment.integration.domain.TradeNoAioObj;
...
import project_pet_backEnd.ecpay.payment.integration.verification.VerifyAioCheckOut;
import project_pet_backEnd.ecpay.payment.integration.verification.VerifyCreateServerOrder;
import project_pet_backEnd.ecpay.payment.integration.verification.VerifyDoAction;
import project_pet_backEnd.ecpay.payment.integration.verification.VerifyFundingReconDetail;
import project_pet_backEnd.ecpay.payment.integration.verification.VerifyQueryCreditTrade;
import project_pet_backEnd.ecpay.payment.integration.verification.VerifyQueryTrade;
import project_pet_backEnd.ecpay.payment.integration.verification.VerifyQueryTradeInfo;
import project_pet_backEnd.ecpay.payment.integration.verification.VerifyTradeNoAio;
